...
var es_plugin =
  '"https://block.gxb.io/search/gxchain*/data/_search?pretty=true"';
...
if (isTest) {
  ...
  es_plugin =
    '"https://testnet.gxchain.org/search/gxchain*/data/_search?pretty=true"';
...
if (isDev) {
  ...
  es_plugin =
    '"http://47.96.164.78:28090/search/gxchain*/data/_search?pretty=true"';
  JSON.stringify({
    blockchain: 'gxc',
    protocol: 'http',
    host: '47.96.164.78',
