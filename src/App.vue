    ...
    <div class="main-container">
      <div class="text-center" v-if="keywords">
        <div id="seg" class="btn-group btn-group-lg" role="group">
          <router-link
            :to="{ path: '/block/' + keywords }"
            class="btn btn-default"
            >{{ $t('header.block') }}
          </router-link>
          <router-link
            :to="{ path: '/transaction/' + keywords }"
            class="btn btn-default"
          >
            {{ $t('header.transaction') }}
          </router-link>
          <router-link
            :to="{ path: '/account/' + keywords }"
            class="btn btn-default"
            >{{ $t('header.account') }}
          </router-link>
          <router-link
            :to="{ path: '/asset/' + keywords }"
            class="btn btn-default"
            >{{ $t('header.asset') }}
          </router-link>
        </div>
...
export default {
  ...
  created() {
    this.$http
      .get('//static.gxb.io/gxs/symbols/maps.json?v=' + new Date().getTime())
      .then(resp => {
