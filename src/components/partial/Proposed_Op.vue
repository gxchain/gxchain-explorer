      ...
      <div class="panel-body no-padding">
        <div class="table-responsive">
          <table class="table table-striped no-margin">
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.limit_order_create')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-danger">{{$t('transaction.trxTypes.limit_order_cancel')}}</span></td>
            </tr>
            </tbody>
            <!-- 3:call_order_update -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.call_order_update')}}</span></td>
            </tr>
            </tbody>
            <!-- 4:fill_order -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.fill_order')}}</span></td>
            </tr>
            </tbody>
            <!-- 5:account_create -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.account_upgrade.name')}}</span></td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.account_upgrade.account_to_upgrade')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].account_to_upgrade}">{{formatted_account(op[1].account_to_upgrade,'account_to_upgrade')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.account_transfer.name')}}</span></td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.account_transfer.account_id')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].account_id}">{{formatted_account(op[1].account_id,'account_id')}}</router-link></td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.account_transfer.new_owner')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].new_owner}">{{formatted_account(op[1].new_owner,'new_owner')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.asset_create.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_update')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_update_bitasset')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_update_feed_producers')}}</span></td>
            </tr>
            </tbody>
            <!-- 14:asset_issue -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.asset_issue.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td align="right">{{formatted_number(op[1].asset_to_issue.asset_id,op[1].asset_to_issue.amount,5)}}</td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.asset_issue.issue_to_account')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].issue_to_account}">{{formatted_account(op[1].issue_to_account,'issue_to_account')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-danger">{{$t('transaction.trxTypes.asset_reserve')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_fund_fee_pool')}}</span></td>
            </tr>
            </tbody>
            <!-- 17:asset_settle -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_settle')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_global_settle')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.asset_publish_feed')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.witness_create')}}</span></td>
            </tr>
            </tbody>
            <!-- 21:witness_update -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.withdraw_permission_create')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.withdraw_permission_update')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.withdraw_permission_claim')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-danger">{{$t('transaction.trxTypes.withdraw_permission_delete')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.committee_member_create')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.committee_member_update')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.committee_member_update_global_parameters')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.vesting_balance_create')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.vesting_balance_withdraw.name')}}</span></td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.vesting_balance_withdraw.owner')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].owner}">{{formatted_account(op[1].owner,'owner')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.worker_create')}}</span></td>
            </tr>
            </tbody>
            <!-- 35:custom -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.custom')}}</span></td>
            </tr>
            </tbody>
            <!-- 36:assert -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.assert')}}</span></td>
            </tr>
            </tbody>
            <!-- 37:balance_claim -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.balance_claim')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.override_transfer.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.transfer_to_blind')}}</span></td>
            </tr>
            </tbody>
            <!-- 40:blind_transfer -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.blind_transfer')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.transfer_from_blind')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-danger">{{$t('transaction.trxTypes.asset_settle_cancel')}}</span></td>
            </tr>
            </tbody>
            <!-- 43:asset_claim_fees -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.asset_claim_fees')}}</span></td>
            </tr>
            </tbody>
            <!-- 44:fba_distribute -->
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.fba_distribute')}}</span></td>
            </tr>
            </tbody>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.account_upgrade_merchant.name')}}</span></td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.account_upgrade_merchant.auth_referrer')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].auth_referrer}">{{formatted_account(op[1].auth_referrer,'auth_referrer')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.account_upgrade_datasource.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trxTypes.account_upgrade_datasource.upgrade_to_datasource_member')}}</th>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.data_transaction_update.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td align="right"><router-link :to="{path: '/account/'+op[1].new_requester}">{{formatted_account(op[1].new_requester,'new_requester')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.account_upgrade_data_transaction_member.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trxTypes.account_upgrade_data_transaction_member.upgrade_to_data_transaction_member')}}</th>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.data_transaction_datasource_validate_error.name')}}</span></td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.data_transaction_datasource_validate_error.request_id')}}</th>
              <td align="right">{{op[1].request_id}}</td>
            </tr>
            <tr>
              <th>{{$t('transaction.trxTypes.data_transaction_datasource_validate_error.datasource')}}</th>
              <td align="right"><router-link :to="{path: '/account/' + op[1].datasource}">{{formatted_account(op[1].datasource,'datasource')}}</router-link></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.balance_lock.name')}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>{{$t('transaction.trx_type')}}</th>
              <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.balance_unlock.name')}}</span></td>
            </tr>
            <tr>
