            ...
            <div class="table-responsive">
                <table class="table table-striped no-margin">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <router-link :to="{path: '/account/' + op[1].from}">{{formatted_account(op[1].from, 'from')}}</router-link>
                        </td>
                    </tr>
                    <tr>
                        <th>{{$t('transaction.trxTypes.transfer.to')}}</th>
                        <td align="right">
                            <router-link :to="{path: '/account/' + op[1].to}">{{formatted_account(op[1].to, 'to')}}
                            </router-link>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-danger">{{$t('transaction.trxTypes.limit_order_cancel')}}</span></td>
                    </tr>
                    </tbody>
                    <!-- 3:call_order_update -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-primary">{{$t('transaction.trxTypes.call_order_update')}}</span></td>
                    </tr>
                    </tbody>
                    <!-- 4:fill_order -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-primary">{{$t('transaction.trxTypes.fill_order')}}</span></td>
                    </tr>
                    </tbody>
                    <!-- 5:account_create -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-warning">{{$t('transaction.trxTypes.asset_create.name')}}</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-warning">{{$t('transaction.trxTypes.asset_issue.name')}}</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span class="label label-warning">{{$t('transaction.trxTypes.witness_create')}}</span>
                        </td>
                    </tr>
                    </tbody>
                    <!-- 21:witness_update -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.witness_update')}}</span>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.custom.name')}}</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.assert')}}</span>
                        </td>
                    </tr>
                    </tbody>
                    <!-- 37:balance_claim -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-primary">{{$t('transaction.trxTypes.transfer_to_blind')}}</span></td>
                    </tr>
                    </tbody>
                    <!-- 40:blind_transfer -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.blind_transfer')}}</span>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-primary">{{$t('transaction.trxTypes.asset_claim_fees')}}</span></td>
                    </tr>
                    </tbody>
                    <!-- 44:fba_distribute -->
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span class="label label-primary">{{$t('transaction.trxTypes.fba_distribute')}}</span>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <tr>
                        <th>{{$t('transaction.trxTypes.account_upgrade_data_transaction_member.account_to_upgrade')}}
                        </th>
                        <td align="right">
                            <router-link :to="{path: '/account/' + op[1].account_to_upgrade}">
                                {{formatted_account(op[1].account_to_upgrade, 'account_to_upgrade')}}
                    ...
                    <tr>
                        <th>{{$t('transaction.trx_type')}}</th>
                        <td align="right"><span
                                class="label label-primary">{{$t('transaction.trxTypes.balance_lock.name')}}</span></td>
                    </tr>
                    <tr>
