    ...
    <tr v-for="(op,index) in latestTransactions" :key="index" :class="((index > 8)&&(parent == 'Account')) ? 'collapse' : ''">
      ...
      <td align="right" v-if="ops[op[0]] == 'transfer'">
        <i18n path="transaction.operation.transfer">
          <router-link place="from" :to="{path: '/account/' + formatted_account(op[1].from)}">{{ formatted_account(op[1].from) }}
          </router-link>
          <span place="amount">{{ formatted_number(op[1].amount.asset_id, op[1].amount.amount, 5) }}</span>
          <router-link place="to" :to="{path: '/account/' + formatted_account(op[1].to)}">{{ formatted_account(op[1].to) }}
          </router-link>
        </i18n>
      </td>
      ...
      <th v-if="ops[op[0]] == 'asset_reserve'">
        <router-link :to="{path: '/block/' + op['block_id']}">
          <span data-toggle="tooltip" data-placement="bottom" :title="'显示收录交易的区块信息 #' + op['block_id']"  class="label label-danger">{{$t('transaction.trxTypes.asset_reserve')}}</span>
        </router-link>
      </th>
      ...
      <th v-if="ops[op[0]] == 'witness_create'">
        <router-link :to="{path: '/block/' + op['block_id']}">
          <span data-toggle="tooltip" data-placement="bottom" :title="'显示收录交易的区块信息 #' + op['block_id']"  class="label label-warning">{{$t('transaction.trxTypes.witness_create')}}</span>
        </router-link>
      </th>
      ...
      <th v-if="ops[op[0]] == 'witness_update'">
        <router-link :to="{path: '/block/' + op['block_id']}">
          <span data-toggle="tooltip" data-placement="bottom" :title="'显示收录交易的区块信息 #' + op['block_id']"  class="label label-primary">{{$t('transaction.trxTypes.witness_update')}}</span>
        </router-link>
      </th>
      ...
      <th v-if="ops[op[0]] == 'committee_member_create'">
        <router-link :to="{path: '/block/' + op['block_id']}">
          <span data-toggle="tooltip" data-placement="bottom" :title="'显示收录交易的区块信息 #' + op['block_id']"  class="label label-warning">{{$t('transaction.trxTypes.committee_member_create')}}</span>
        </router-link>
      </th>
      ...
      <th v-if="ops[op[0]] == 'committee_member_update'">
        <router-link :to="{path: '/block/' + op['block_id']}">
          <span data-toggle="tooltip" data-placement="bottom" :title="'显示收录交易的区块信息 #' + op['block_id']"  class="label label-primary">{{$t('transaction.trxTypes.committee_member_update')}}</span>
        </router-link>
      </th>
      ...
      <th v-if="ops[op[0]] == 'custom'">
        <router-link :to="{path: '/block/' + op['block_id']}">
          <span data-toggle="tooltip" data-placement="bottom" :title="'显示收录交易的区块信息 #' + op['block_id']"  class="label label-primary">{{$t('transaction.trxTypes.custom')}}</span>
        </router-link>
      </th>
