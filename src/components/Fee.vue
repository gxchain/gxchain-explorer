                            ...
                            <tbody>
                                ...
                                <template v-for="(item, index) in get_data(index_g)">
                                    <tr v-for="(item2, index2) in item">
                                        <td v-if="index2 == 0" :rowspan=item.length class="text-center">{{$t('fee.trxTypes.' + item2.fee_name)}}</td>
                                        <td class="text-right">{{$t('fee.feeTypes.' + item2.fee_xx)}}</td>
                                        <td v-if="item2.assetAmount == 0" class="text-right">{{$t('fee.feeTypes._none')}}</td>
                                        <td v-else class="text-right">{{item2.assetAmount}}</td>
                                        <td v-if="item2.assetAmountLTM == 0" class="text-right">{{$t('fee.feeTypes._none')}}</td>
                                        <td v-else class="text-right">{{item2.assetAmountLTM}}</td>
                                    </tr>
                                </template>
...
let op_ids = [0, 25, 26, 27, 28, 32, 33, 37, 39, 40, 10, 11, 14, 5, 6, 7, 8, 9, 20, 21, 22, 23, 24, 29, 30, 31, 34, 35, 36];
