<template>
    <div class="container">
        ...
        <h4 class="page-header"
            v-show="!loading">{{$t('index.latest_status')}}:
        ...
        <div class="row">
            ...
            <!--Blocks-->
            <div class="col-md-12">
                <div v-if="block_info&&global_params&&supply_info"
            ...
            <!--Histories-->
            <div class="col-md-12">
                <div v-if="latestBlocks"
                     class="panel panel-default panel-histories">
                    <div class="panel-heading">
                        ...
                        <table class="table table-striped no-margin"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="right"
                                        width="80">{{$t('index.transactions.time')}}</th>
                                </tr>
                            </thead>
            ...
            <div class="col-md-12">
                <div class="panel panel-default panel-ranking">
                    <div class="panel-heading">
                        ...
                        <span>
                            <button class="btn btn-xs btn-ranking"
                                ...
                                <tr v-for="(item,i) in rankings">
                                    ...
                                    <td>
                                        <account-image :size="8"
                                                       ...
                                                       :type="item.accountType"></account-image>
                                        &nbsp;
                                ...
                                <tr v-for="asset in assets"
                                    ...
                                    <td>
                                        <account-image :size="8"
                                                       ...
                                                       :type="asset.issuer.code ? 2 : 1"></account-image>
                                        &nbsp;
