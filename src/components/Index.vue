    ...
    <div class="row">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <router-link
                      :to="{
                        path: '/block/' + block_info.last_irreversible_block_num
                      }"
                    >
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-right">
                    {{ $t('index.ranking.locked_balance') }}
                  </th>
                  <th class="text-right">{{ $t('index.ranking.balance') }}</th>
                  <th class="text-right">
                    {{ $t('index.ranking.total_balance') }}
                  </th>
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <span class="fa fa-fw gxicon gxicon-asset"></span>
            {{ $t('index.asset.title') }}
          </div>
          <div class="panel-body no-padding">
