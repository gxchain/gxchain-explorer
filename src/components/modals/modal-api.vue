  ...
  computed: {
    apis() {
      return [
        ...
        {
          name: this.$t('api.fetch_vest_balance'),
          api: '/api/vest_balance/:id_or_name',
          example: `http://${location.host}/api/vest_balance/paul`
        },
        {
        ...
        },
        {
          ...
          example: `http://${location.host}/api/trustnode/candidates`
        }
      ];
    }
  }
