        ...
        <div v-if="global_params" class="panel panel-default">
          ...
          <div class="panel-body no-padding">
            <table class="table table-striped no-margin">
              ...
              <tbody>
                <tr
                  v-for="member in global_params.active_committee_members"
                  :key="member"
                >
                  <td>
                    <account-image
          ...
          <div class="panel-body no-padding">
            <div class="table-responsive">
              <table class="table table-striped no-margin">
                ...
                <tbody>
                  <tr
                    v-for="witness in global_params.active_witnesses"
                    :key="witness"
                    :class="{
                      info:
                  ...
                  <tr v-for="(c, index) in candidates.first" :key="c.account">
                    ...
                    <td>
                      <div v-if="candidates.second[index]">
                        <img
                          v-if="
                            candidates.second[index].extra &&
                              candidates.second[index].extra.logo
                          "
                          :src="candidates.second[index].extra.logo"
                          width="16px"
                        />
                        <account-image
                          v-if="
                          ...
                          "
                          :size="8"
                          :account="candidates.second[index].account"
                          :type="1"
                        ></account-image>
                        &nbsp;
                        <router-link
                          :to="{
                            path: '/account/' + candidates.second[index].account
                          }"
                        >
                      ...
                      <div v-if="candidates.second[index]">
                        <small class="tip">{{
                          candidates.second[index].extra
                            ? candidates.second[index].extra.nodeName
                            : ''
                        }}</small>
                      </div>
                    </td>
