<template>
  <div class="container">
    ...
    <div
      class="row"
      v-if="transaction && transaction.current_block_number"
      v-show="!loading"
    >
      <div class="col-md-12">
                ...
                <tbody>
                  <tr>
                    ...
                    <td align="right">
                      <router-link
                        :to="{
                          path: '/block/' + transaction.current_block_number
                        }"
                      >
...
export default {
  ...
  methods: {
    ...
    fetch_transaction() {
      ...
      let self = this;
      this.transaction = {};
      fetch_transaction(this.$route.params.tx_id)
        .then(function(resp) {
